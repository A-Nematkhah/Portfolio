      ...
      <div className="mx-auto max-w-3xl space-y-4">
        ...
        <div className="rounded-2xl glass p-6">
          <p className="text-sm text-muted-foreground">
            You're signed in. Manage projects directly on the public site — admin controls (Add /
            Edit / Delete) are now visible inside each category tab.
          </p>
          <Link
            to="/"
            className="mt-4 inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground glow-primary hover:opacity-90 transition"
          >
