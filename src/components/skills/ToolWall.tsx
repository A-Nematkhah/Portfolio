...
const GUTTERS: Record<ToolDomainId, GutterTool[]> = {
  ...
  robotics: [
    {
      id: "pcb",
      src: toolAsset("pcb-green.webp"),
      alt: "Microcontroller board",
      col: 2,
      row: "1 / 3",
      width: 87,
      rotate: -6,
  ...
  ai: [
    {
      id: "ultrasonic",
      src: toolAsset("ultrasonic-sensor.webp"),
    ...
    {
      id: "chip",
      src: toolAsset("ic-chip.webp"),
      alt: "AI accelerator chip",
      col: 4,
      row: "1",
      width: 132,
      rotate: 9,
...
const TOOLS: ToolItem[] = [
  {
    ...
    matchKeywords: ["solidworks"],
    filterCategory: "3D Models",
    status: "ACTIVE",
    icon: Box,
    tilt: -2,
  },
  ...
  },
  {
    ...
    matchKeywords: ["autocad"],
    filterCategory: "2D Drawings",
    status: "ACTIVE",
    icon: Ruler,
    tilt: 1.5,
  },
  ...
  },
  {
    ...
    matchKeywords: ["mechanical design"],
    status: "ACTIVE",
    icon: Hammer,
    tilt: -2,
  },
  {
    ...
    matchKeywords: ["microsoft project", "ms project"],
    status: "ACTIVE",
    icon: ClipboardList,
    tilt: 1,
  },
  {
    ...
    matchKeywords: ["project planning"],
    status: "ACTIVE",
    icon: ClipboardList,
    tilt: -1,
  },
  {
    ...
    matchKeywords: ["simulation", "analysis"],
    status: "ACTIVE",
    icon: Cog,
    tilt: 2,
  },
  ...
  },
  {
    ...
    matchKeywords: ["siemens", "logo plc", "plc"],
    status: "ACTIVE",
    icon: Plug,
    tilt: 2,
  },
  ...
  },
  {
    ...
    matchKeywords: ["intelligent automation", "automation"],
    status: "RESEARCH",
    icon: Cog,
    tilt: 1,
  },
  ...
  },
  {
    ...
    matchKeywords: ["reinforcement learning", "reinforcement"],
    status: "RESEARCH",
    icon: Brain,
    tilt: 1.5,
  },
  {
    ...
    matchKeywords: ["llm", "language model"],
    status: "EXPERIMENTAL",
    icon: Sparkles,
    tilt: -1,
  },
                          ...
                          >
                            ...
                            >
                              ...
                              <span className="flex items-start gap-2">
                                <Icon
                                  className="skill-card-icon mt-0.5 h-[19px] w-[19px] shrink-0 text-foreground"
                                  strokeWidth={1.7}
                                />
